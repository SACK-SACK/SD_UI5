		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SD] 계약 내역 조회 및 납기 일정 변경 조회",
									"targetURL": "#synccasddeliveryscheduledisplay-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccasddeliveryscheduledisplay-display": {
								"semanticObject": "synccasddeliveryscheduledisplay",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.sd.deliveryscheduledisplay",
									"url": sap.ui.require.toUrl("sync/ca/sd/deliveryscheduledisplay")
								}
							}
						}
					}
