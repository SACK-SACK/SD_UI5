		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "새로운 계약 생성",
									"targetURL": "#synccasdcreatenewcontract-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccasdcreatenewcontract-display": {
								"semanticObject": "synccasdcreatenewcontract",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.sd.create.newcontract",
									"url": sap.ui.require.toUrl("sync/ca/sd/create/newcontract")
								}
							}
						}
					}
