		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SD] 납기일 변경 요청 승인 ",
									"targetURL": "#synccasdappdatechange-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccasdappdatechange-display": {
								"semanticObject": "synccasdappdatechange",
								"action": "display",
								"description": "납기일 변경 요청 승인을 위한 프로그램 ",
								"title": "[SD] 납기일 변경 요청 승인 ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.sd.app.date.change",
									"url": sap.ui.require.toUrl("sync/ca/sd/app/date/change")
								}
							}
						}
					}
